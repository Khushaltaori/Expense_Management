...
export default function LoginPage() {
  ...
  // If already logged in, show success then redirect to home
  useEffect(() => {
        ...
        {isSuccess ? (
          ...
          >
            ...
            >
              <Link
                href="/"
                className="inline-flex items-center gap-2 text-sm text-cyan-300 transition-all duration-300 hover:gap-3 hover:text-cyan-200"
              >
                Go to Home
                ...
                <div className="relative p-7 sm:p-8">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="group flex w-full items-center justify-center gap-3 rounded-xl border px-6 py-3.5 text-sm font-medium backdrop-blur-sm transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
